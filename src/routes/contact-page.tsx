...
export default function ContactPage() {
  ...
  const visitAddress =
    "Sr No 622/2, Near Saint Gobain Sekurit Ltd, Village Kuruli, Taluka Khed, Pune 410501";
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("access_key", "bbf54d1d-fcd1-4a00-a9cb-8ef5a94ce3a7");
    formData.append("subject", "New Contact Enquiry - Laxmi Sagar Engineers");
    formData.append("from_name", String(formData.get("name") || "Laxmi Sagar Contact Page"));
          ...
          <Reveal>
            ...
            <div className="mt-10 space-y-5">
              ...
              <InfoCard
                icon={Clock}
                title="Working Hours"
                lines={[`Daily: ${SITE.workingHours}`, `${SITE.weeklyOff}: Off`]}
              />
            </div>
          </Reveal>
